...
#Example command call: bash scrublet-ATAC-auto.sh /diskmnt/Projects/PDX_scRNA_analysis/matching_snRNAseq/PDAC/cellranger-arc2
...
for dir in $cellrangerpath/*; do
    ...
    then
        ...
        then
            ...
            mkdir $dir
            cd $dir
            python3 /diskmnt/Projects/Users/austins2/tools/scrublet-comboATAC-auto.py -s $dir -c $cellrangerpath/$dir -u 0.2
            cd ..
        else
